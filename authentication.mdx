---
title: "Authenticate with VinylVibes API Using JWT"
sidebarTitle: "Authentication"
description: "VinylVibes API uses JWT bearer tokens for authentication. Tokens are issued at login, expire in 7 days, and encode user ID, name, and role."
---
...
Send your credentials to `POST /login`. A stricter rate limit applies to this endpoint — a maximum of **10 attempts per 15 minutes** per IP.
