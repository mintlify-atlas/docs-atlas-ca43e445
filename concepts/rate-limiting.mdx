---
title: "VinylVibes API Rate Limiting: Global and Auth-Endpoint Rules"
sidebarTitle: "Rate Limiting"
description: "VinylVibes API enforces a 100 req/min global limit and a 10 req/15 min auth-specific limit, blocking abusive clients with HTTP 429 before any handler runs."
---
