---
title: "Redis Diagnostics: Cache Health and Keys Inspector"
sidebarTitle: "Redis Ping"
description: "Checks Redis connectivity via PING and returns the total count and a sorted list of all currently cached keys. Accessible to admin and demo roles only."
---
